    ...
    <div class="col-sm-6">
      <div class="card">
        <div class="card-body">
          ...
          <p class="card-text">
            Input a new skill into the system. You will not be able to create an
            existing skill.
          </p>
          <router-link class="btn" id="card-button" to="/CreateSkill"
    ...
    <div class="col-sm-6">
      <div class="card">
        <div class="card-body">
          ...
          <router-link class="btn" id="card-button" to="/ViewStaff"
